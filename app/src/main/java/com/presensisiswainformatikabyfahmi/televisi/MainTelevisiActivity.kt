package com.presensisiswainformatikabyfahmi.televisi
...
class MainTelevisiActivity : AppCompatActivity() {
    ...
    private fun showToast(message: String) {
        ...
        val layout = inflater.inflate(R.layout.tv_custom_toast, findViewById(R.id.toast_container))
